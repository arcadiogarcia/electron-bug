...
if (typeof responsiveVoice != 'undefined') {
    ...
    var ResponsiveVoice = function () {
        ...
        self.OnVoiceReady = function() {
            console.log("OnVoiceReady");
            //responsiveVoice.speak("Voice system activated.");
        };
                ...
                setTimeout(function () {
                    var gsvinterval = setInterval(function () {
                        ...
                        if (v.length == 0 && (systemvoices == null || systemvoices.length == 0)) {
                            ...
                            responsiveVoice.speak("Voice support ready.");
                            systemVoicesReady(v);
    ...
    console.log("ResponsiveVoice instantiated (globally)");
}
